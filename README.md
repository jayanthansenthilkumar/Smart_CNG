...
If you want a fast, local verification of core endpoints without opening a browser, run the included smoke tester.
...
This will call a few API endpoints and print readable JSON responses so you can confirm the app can read the station CSV and respond.
